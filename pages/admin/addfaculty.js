        ...
        if (FormData.name !== "" && FormData.email !== "" && FormData.role !== "" && FormData.gender !== "") {
            ...
            try {
                ...
                if (result.success === true) {
                    ...
                    setFormData({ name: "", email: "", gender: "", role: "", phone: "" });
            ...
            <div className="p-4 sm:ml-64">
                ...
                <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                    <div className="flex flex-col align-center justify-center">
                        <h2 className='flex mb-4 text-3xl font-semibold'>Add Faculty</h2>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4">
                                <h3 className="mb-2 text-gray-900 dark:text-white">Gender</h3>
